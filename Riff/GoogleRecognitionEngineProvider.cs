...
namespace Riff
{
    public class GoogleRecognitionEngineProvider : IRecognitionEngineProvider
    {
        ...
        private MicrophoneContext m_microphoneContext;
        private readonly StreamingRecognizeRequest m_streamingRecognizeRequest;
        private readonly SpeechHandlerChain m_speechHandlerChain;
        #endregion

        #region Constructor(s)
        public GoogleRecognitionEngineProvider()
        {
            m_client = SpeechClient.Create();
            m_microphoneContext = Bootstrapper.ResolveType<MicrophoneContext>();
